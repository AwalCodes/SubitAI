          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-white rounded-2xl p-8 border border-neutral-200 space-y-8">
                <section>
                  <h2 className="text-xl font-bold text-neutral-900 mb-3">Scope of Service</h2>
                ...
                <section>
                  <h2 className="text-xl font-bold text-neutral-900 mb-3">User Responsibilities</h2>
                ...
                <section>
                  <h2 className="text-xl font-bold text-neutral-900 mb-3">Payments and No Refund Policy</h2>
                  <ul className="list-disc pl-6 space-y-2 text-neutral-600">
                    ...
                    <li><strong className="text-neutral-900">No Refund Policy:</strong> All payments are final and non-refundable under any circumstances.</li>
                  </ul>
                </section>

                <section>
                  <h2 className="text-xl font-bold text-neutral-900 mb-3">Account Suspension or Termination</h2>
                  <p className="text-neutral-600">
