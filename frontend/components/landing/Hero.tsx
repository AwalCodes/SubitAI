    ...
    <section className="relative overflow-hidden bg-white py-20 lg:py-32">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-5xl mx-auto">
          {/* Feature Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-subit-50 border border-subit-200 rounded-full text-sm font-medium mb-8">
            <Sparkles className="w-4 h-4 text-subit-600" />
            <span className="text-subit-700">
