...
export function FloatingHelp() {
  ...
  return (
    <>
      {/* Help button - positioned above search button to avoid blocking it */}
      <motion.button
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.95 }}
        onClick={() => setIsOpen(true)}
        className="fixed bottom-20 right-6 z-30 flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-r from-subit-500 to-subit-600 text-white shadow-lg hover:shadow-xl transition-all duration-200"
        aria-label="Get help"
        style={{ zIndex: 30 }}
      >
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-36 right-6 w-80 bg-white dark:bg-neutral-900 rounded-2xl shadow-2xl border border-neutral-200 dark:border-neutral-800 z-50 overflow-hidden"
            >
