  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-6 left-6 z-40 flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-r from-subit-500 to-subit-600 text-white shadow-lg hover:shadow-xl transition-all duration-200"
        aria-label="Get help"
      >
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-24 left-6 w-80 bg-white dark:bg-neutral-900 rounded-2xl shadow-2xl border border-neutral-200 dark:border-neutral-800 z-50 overflow-hidden"
            >
